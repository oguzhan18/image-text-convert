![image-text-convert](https://socialify.git.ci/oguzhan18/image-text-convert/image?language=1&name=1&owner=1&pattern=Circuit%20Board&stargazers=1&theme=Light)
